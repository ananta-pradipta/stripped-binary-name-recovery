...
\begin{table}[t]
    ...
    \begin{tabular}{lrcc}
        \toprule
        \textbf{Package} & \textbf{Funcs} & \textbf{$k$-NN+BinFilter F1} & \textbf{Decoder F1} \\
        \midrule
        nginx118 & 3{,}470 & \textbf{0.883} & 0.787 \\
        angie    & 3{,}893 & \textbf{0.814} & 0.699 \\
        tengine  &   554   & 0.738 & 0.685 \\
        recutils & 2{,}550 & 0.343 & 0.296 \\
        \midrule
        \textbf{Overall} & \textbf{10{,}467} & \textbf{0.718} & \textbf{0.673} \\
        Overall (nginx-family only) & 7{,}917 & 0.843 & 0.744 \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{figure}[t]
    ...
    \Description{Scatter plot with parameters (log scale, x-axis) versus cross-project F1 (y-axis). GraphR at 32M / 0.718 sits in the upper-left corner of the plot. SymGen+LoRA at 34B / 0.663 and StarCoder-3B at 3B / 0.654 sit further right with comparable or lower F1.}
    \label{fig:pareto}
\end{figure}
