...
\begin{document}
    ...
    % ----- Output heads -----
    \node[dec, left=1.0cm of g3] (decoder) {GRU Decoder\\{\scriptsize\ttfamily1024 hidden, 1 layer}\\{\scriptsize Votes vocab 7,004}\\{\scriptsize beam search $k{=}5$}};
    \node[dec, below=0.6cm of decoder] (knn) {$k$-NN + BinFilter\\{\scriptsize\ttfamily $k{=}20$, $\tau{=}0.5$}\\{\scriptsize 300K training index}};
