...
\begin{table}[t]
    \centering
    \caption{Main results on the 300K-trained 25M model comparing Decoder, unfiltered $k$-NN, and $k$-NN + BinFilter. All three use the same encoder; only the output head differs.}
    \label{tab:main}
    \footnotesize
    \begin{tabular}{lcccc}
        \toprule
