...
> Anonymous artifact for FSE 2027 double-anonymous review.
...
```bash
# Anonymous read-only mirror during review (anonymous.4open.science); download the zip from the mirror
cd stripped-binary-name-recovery-fse
